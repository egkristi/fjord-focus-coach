# Fjord Focus Coach — Licensing

Fjord Focus Coach uses a **dual-license model**: open source for the community,
...
Fjord Focus Coach is licensed under the
[GNU Affero General Public License v3.0](LICENSES/AGPLv3.txt) (AGPLv3).

This covers:
- Breathing exercise timer
- Coastline statistics integration
...
1. Use Fjord Focus Coach commercially with **>50 users** and **>$5M revenue/year**
2. Distribute Fjord Focus Coach inside a product **without** releasing your source under AGPLv3
3. Offer Fjord Focus Coach as a **hosted/managed service** without releasing modifications
...
|---------|:---:|:---:|
| Breathing exercise timer | ✅ | ✅ |\n| Coastline statistics integration | ✅ | ✅ |\n| Minimalist UI components | ✅ | ✅ |\n| Offline-capable PWA | ✅ | ✅ |\n| **Multi-user team wellness tracking** | — | ✅ |\n| **Custom breathing programs** | — | ✅ |\n| **Enterprise health dashboard integration** | — | ✅ |\n| **Advanced analytics and reporting** | — | ✅ |\n
---
...
**The SaaS loophole:** MIT and Apache 2.0 allow cloud providers to offer Fjord Focus Coach
...
Open an issue: https://github.com/egkristi/fjord-focus-coach/issues
